...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var tempVC: TempWindowController?
    ...
    func createWindow() {
        ...
        if self.tempVC == nil {
            ...
            //设置到控制器中
            self.tempVC = TempWindowController(window: myWindow)
        }
        
        //显示window
        self.tempVC?.window?.makeKeyAndOrderFront(nil);
        //居中
        self.tempVC?.window?.center()
    }
