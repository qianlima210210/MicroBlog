...
//  AVFoundationTwo
//
//  Created by maqianli on 2019/7/30.
...
//相机拍摄预览图层，是CALayer的子类，使用该对象可以实时查看拍照或视频录制效果
...
- (void)beginVideoConfiguration
{
    ...
    //开始会话，不等于录制
    [self.captureSession startRunning];//viewWillAppear中也有startRunning？？？
}
